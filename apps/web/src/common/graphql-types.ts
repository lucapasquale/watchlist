...
export type AddItemUrlInformationQuery = { __typename?: 'Query', urlInformation?: { __typename?: 'UrlInformation', kind: PlaylistItemKind, title: string, thumbnailUrl: string, embedUrl: string, durationSeconds: number } | null };
...
export type PlaylistViewQuery = { __typename?: 'Query', playlist: { __typename?: 'Playlist', id: string, name: string, newItemsPosition: PlaylistNewItemsPosition, itemsCount: number, createdAt: any, user: { __typename?: 'User', id: string, name: string, initials: string, profilePictureUrl?: string | null }, firstItem?: { __typename?: 'PlaylistItem', id: string } | null, shuffleFirstItem?: { __typename?: 'PlaylistItem', id: string } | null, items: Array<{ __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, href: string }> } };
...
export type MovePlaylistItemMutation = { __typename?: 'Mutation', movePlaylistItem: { __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, href: string, playlist: { __typename?: 'Playlist', id: string, firstItem?: { __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, href: string, nextItem?: { __typename?: 'PlaylistItem', id: string } | null } | null, items: Array<{ __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, href: string, nextItem?: { __typename?: 'PlaylistItem', id: string } | null }> }, nextItem?: { __typename?: 'PlaylistItem', id: string } | null } };
...
export type DeletePlaylistItemMutation = { __typename?: 'Mutation', deletePlaylistItem: { __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, href: string, playlist: { __typename?: 'Playlist', id: string, firstItem?: { __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, href: string, nextItem?: { __typename?: 'PlaylistItem', id: string } | null } | null, items: Array<{ __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, href: string, nextItem?: { __typename?: 'PlaylistItem', id: string } | null }> }, nextItem?: { __typename?: 'PlaylistItem', id: string } | null } };

export type PlaylistItemFragFragment = { __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, href: string, nextItem?: { __typename?: 'PlaylistItem', id: string } | null };

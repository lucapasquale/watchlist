...
export type HomePlaylistsQuery = {
  __typename?: "Query";
  playlists: Array<{ __typename?: "Playlist"; id: string; name: string }>;
};
...
export type PlaylistItemViewQuery = {
  __typename?: "Query";
  playlistItem: {
    __typename?: "PlaylistItem";
    id: string;
    ...
    url: string;
    rawUrl: string;
    playlist: { __typename?: "Playlist"; id: string; name: string };
    nextItem?: { __typename?: "PlaylistItem"; id: string } | null;
  };
};
...
export type PlaylistItemQueueSidebarQuery = {
  __typename?: "Query";
  playlist: {
    __typename?: "Playlist";
    id: string;
...
export type AddItemUrlInformationQuery = {
  __typename?: "Query";
  urlInformation?: {
    __typename?: "UrlInformation";
    kind: PlaylistItemKind;
...
export type CreatePlaylistItemMutation = {
  __typename?: "Mutation";
  createPlaylistItem: { __typename?: "PlaylistItem"; id: string };
};
...
export type PlaylistViewQuery = {
  ...
  playlist: {
    ...
    firstItem?: { __typename?: "PlaylistItem"; id: string } | null;
    items: Array<{
      __typename?: "PlaylistItem";
      id: string;
      rank: string;
...
export type PlaylistViewShuffleFirstItemQueryVariables = Exact<{
  playlistID: Scalars["ID"]["input"];
  shuffleSeed: Scalars["String"]["input"];
}>;

export type PlaylistViewShuffleFirstItemQuery = {
  __typename?: "Query";
  playlist: {
    __typename?: "Playlist";
    id: string;
    shuffleFirstItem?: { __typename?: "PlaylistItem"; id: string } | null;
  };
};
...
export type PlaylistItemFragFragment = {
  __typename?: "PlaylistItem";
  id: string;
  rank: string;
  kind: PlaylistItemKind;
...
export type UserViewQuery = {
  ...
  user: {
    ...
    initials: string;
    profilePictureUrl?: string | null;
    playlists: Array<{ __typename?: "Playlist"; id: string; name: string; itemsCount: number }>;
  };
};
...
export type CreatePlaylistFromYoutubeMutation = {
  __typename?: "Mutation";
...
export type DeletePlaylistMutation = {
  __typename?: "Mutation";
  deletePlaylist: { __typename?: "Playlist"; id: string };
};

export const PlaylistItemFragFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "PlaylistItemFrag" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "PlaylistItem" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
...
} as unknown as DocumentNode<PlaylistItemFragFragment, unknown>;
export const UserProviderDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "UserProvider" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<UserProviderQuery, UserProviderQueryVariables>;
export const HomePlaylistsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "HomePlaylists" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<HomePlaylistsQuery, HomePlaylistsQueryVariables>;
export const PlaylistItemViewDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      variableDefinitions: [
        {
          ...
          variable: { kind: "Variable", name: { kind: "Name", value: "playlistItemID" } },
          type: {
            kind: "NonNullType",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "playlistItem" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
                value: { kind: "Variable", name: { kind: "Name", value: "playlistItemID" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
...
} as unknown as DocumentNode<PlaylistItemViewQuery, PlaylistItemViewQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "PlaylistItemQueueSidebar" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<PlaylistItemQueueSidebarQuery, PlaylistItemQueueSidebarQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "AddItemUrlInformation" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "UrlInformationInput" } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "urlInformation" },
            arguments: [
              {
                kind: "Argument",
...
} as unknown as DocumentNode<AddItemUrlInformationQuery, AddItemUrlInformationQueryVariables>;
export const CreatePlaylistItemDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreatePlaylistItem" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "input" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "CreatePlaylistItemInput" } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<CreatePlaylistItemMutation, CreatePlaylistItemMutationVariables>;
export const PlaylistViewDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "PlaylistView" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "playlistID" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "name" } },
                { kind: "Field", name: { kind: "Name", value: "newItemsPosition" } },
                { kind: "Field", name: { kind: "Name", value: "itemsCount" } },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "firstItem" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [{ kind: "Field", name: { kind: "Name", value: "id" } }],
                  },
...
} as unknown as DocumentNode<PlaylistViewQuery, PlaylistViewQueryVariables>;
export const PlaylistViewShuffleFirstItemDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "PlaylistViewShuffleFirstItem" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "playlistID" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  alias: { kind: "Name", value: "shuffleFirstItem" },
                  name: { kind: "Name", value: "firstItem" },
                  arguments: [
                    {
                      kind: "Argument",
  ...
  PlaylistViewShuffleFirstItemQuery,
  PlaylistViewShuffleFirstItemQueryVariables
>;
...
export const MovePlaylistItemDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "MovePlaylistItem" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "input" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "MovePlaylistItemInput" } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "FragmentSpread", name: { kind: "Name", value: "PlaylistItemFrag" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "playlist" },
                  selectionSet: {
...
} as unknown as DocumentNode<MovePlaylistItemMutation, MovePlaylistItemMutationVariables>;
export const DeletePlaylistItemDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeletePlaylistItem" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<DeletePlaylistItemMutation, DeletePlaylistItemMutationVariables>;
...
export const CreatePlaylistFromYoutubeDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreatePlaylistFromYoutube" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
  ...
  CreatePlaylistFromYoutubeMutation,
  CreatePlaylistFromYoutubeMutationVariables
>;

...
export type HomeHeroPlaylistsQuery = { __typename?: 'Query', playlists: Array<{ __typename?: 'Playlist', id: string, name: string, itemsCount: number, firstItem?: { __typename?: 'PlaylistItem', id: string } | null, user: { __typename?: 'User', id: string, name: string, initials: string, profilePictureUrl?: string | null } }> };

...
export type HomeHeroPlaylistsQuery = { __typename?: 'Query', featuredPlaylists: Array<{ __typename?: 'Playlist', id: string, name: string, itemsKind: Array<PlaylistItemKind>, itemsCount: number, user: { __typename?: 'User', id: string, name: string, initials: string, profilePictureUrl?: string | null }, firstItem?: { __typename?: 'PlaylistItem', id: string } | null }> };

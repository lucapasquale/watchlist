...
export type PlaylistSortableItemsQueryVariables = Exact<{
  playlistID: Scalars['ID']['input'];
}>;


export type PlaylistSortableItemsQuery = { __typename?: 'Query', playlist: { __typename?: 'Playlist', id: string, items: Array<{ __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, rawUrl: string }> } };
...
export type CreatePlaylistItemMutation = { __typename?: 'Mutation', createPlaylistItem: { __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, rawUrl: string, playlist: { __typename?: 'Playlist', id: string, items: Array<{ __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, rawUrl: string }> } } };
...
export type EditPlaylistDataQueryVariables = Exact<{
  playlistID: Scalars['ID']['input'];
}>;


export type EditPlaylistDataQuery = { __typename?: 'Query', playlist: { __typename?: 'Playlist', id: string, name: string, items: Array<{ __typename?: 'PlaylistItem', id: string, rank: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, rawUrl: string }> } };
...
export type PlaylistItemQueueSidebarQuery = { __typename?: 'Query', playlist: { __typename?: 'Playlist', id: string, name: string, itemsCount: number, items: Array<{ __typename?: 'PlaylistItem', id: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string }> } };
...
export type PlaylistItemViewQuery = { __typename?: 'Query', playlistItem: { __typename?: 'PlaylistItem', id: string, kind: PlaylistItemKind, title: string, thumbnailUrl: string, url: string, rawUrl: string, nextItem?: { __typename?: 'PlaylistItem', id: string } | null } };
...
export type PlaylistViewQuery = { __typename?: 'Query', playlist: { __typename?: 'Playlist', id: string, name: string, firstItem?: { __typename?: 'PlaylistItem', id: string } | null, shuffleFirstItem?: { __typename?: 'PlaylistItem', id: string } | null } };
...
export const EditPlaylistDataDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EditPlaylistData"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"playlistID"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"playlist"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"playlistID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PlaylistItemFrag"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PlaylistItemFrag"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"PlaylistItem"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"rank"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"thumbnailUrl"}},{"kind":"Field","name":{"kind":"Name","value":"rawUrl"}}]}}]} as unknown as DocumentNode<EditPlaylistDataQuery, EditPlaylistDataQueryVariables>;
